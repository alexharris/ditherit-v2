        ...
        >
          ...
          <div class="space-y-2">
            ...
            <input
              ...
              name="name"
              required
              class="w-full px-3 py-2 rounded-md bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-ditherit dark:focus:ring-ditherit transition-colors"
            />
          </div>
          ...
          <div class="space-y-2">
            ...
            <textarea
              ...
              rows="5"
              required
              class="w-full px-3 py-2 rounded-md bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-ditherit dark:focus:ring-ditherit transition-colors resize-none"
            ></textarea>
          </div>
