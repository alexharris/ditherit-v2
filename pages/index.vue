        ...
        <div class="flex-1" >
          ...
          <div class="border-solid border shadow-lg rounded py-2 px-4 mt-4" > 
            ...
            <div class="flex flex-row items-center justify-between">
              ...
              <span class="rounded-full h-4 w-4 bg-red-700 text-white flex items-center justify-center float-right text-sm cursor-pointer" @click="showOptionsModalSize = !showOptionsModalSize">
            ...
            <div class="flex flex-row items-center justify-between mt-4">
              ...
              <span class="rounded-full h-4 w-4 bg-red-700 text-white flex items-center justify-center float-right text-sm cursor-pointer" @click="showOptionsModalAlgo = !showOptionsModalAlgo">
            ...
            <div class="inline-block relative w-full" v-if="!showOptionsModalAlgo">
              <select id="ditherAlgo" v-model="rgbQuantOptions.dithKern" class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline">
            ...
            <div v-else>
                <div class="mt-2 bg-red-100 p-2 rounded">
                    These are different ways of spreading the quantization errors around. Certain ones might work better than others depending on the image.
                </div>            
            </div>              
...
export default {
  ...
  methods: {
    downloadImage() {
      ...
      console.log((Math.round((downloadUrl.length - head.length)*3/4))/1000);
